...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double kr_1_1=pars[12];
    long double b1_1_2=pars[13];
    long double k_2_1=pars[14];
    long double kr_2_1=pars[15];
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_4states_rev1u2_TFA_prec100,m){
