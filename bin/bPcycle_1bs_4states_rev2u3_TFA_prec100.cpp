...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double a1_0_2=pars[2];
    long double k_2_0=pars[3];
    long double kr_2_0=pars[4];
    long double a1_0_3=pars[5];
    long double k_3_0=pars[6];
    long double kr_3_0=pars[7];
    long double a1_0_4=pars[8];
    long double k_4_0=pars[9];
    long double b1_1_1=pars[10];
    long double k_1_1=pars[11];
    long double b1_1_2=pars[12];
    long double k_2_1=pars[13];
    long double kr_2_1=pars[14];
    long double b1_1_3=pars[15];
    long double k_3_1=pars[16];
    long double kr_3_1=pars[17];
    ...
    L<<0,b1_1_1,0,0,0,0,k_4_0,0,
a1_0_1*A,0,0,0,0,0,0,k_4_1,
k_1_0,0,0,b1_1_2,kr_2_0,0,0,0,
0,k_1_1,a1_0_2*A,0,0,kr_2_1,0,0,
0,0,k_2_0,0,0,b1_1_3,kr_3_0,0,
0,0,0,k_2_1,a1_0_3*A,0,0,kr_3_1,
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_4states_rev2u3_TFA_prec100,m){
