...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double kr_2_0=pars[5];
    long double a1_0_3=pars[6];
    long double k_3_0=pars[7];
    long double a1_0_4=pars[8];
    long double k_4_0=pars[9];
    long double a1_0_5=pars[10];
    long double k_5_0=pars[11];
    long double b1_1_1=pars[12];
    long double k_1_1=pars[13];
    long double kr_1_1=pars[14];
    long double b1_1_2=pars[15];
    long double k_2_1=pars[16];
    long double kr_2_1=pars[17];
    long double b1_1_3=pars[18];
    long double k_3_1=pars[19];
    long double b1_1_4=pars[20];
    long double k_4_1=pars[21];
    long double b1_1_5=pars[22];
    long double k_5_1=pars[23];
    Matrix<InternalType, Dynamic, Dynamic> L = Matrix<InternalType, Dynamic, Dynamic>::Zero(10, 10);
    L<<0,b1_1_1,kr_1_0,0,0,0,0,0,k_5_0,0,
a1_0_1*A,0,0,kr_1_1,0,0,0,0,0,k_5_1,
k_1_0,0,0,b1_1_2,kr_2_0,0,0,0,0,0,
0,k_1_1,a1_0_2*A,0,0,kr_2_1,0,0,0,0,
0,0,k_2_0,0,0,b1_1_3,0,0,0,0,
0,0,0,k_2_1,a1_0_3*A,0,0,0,0,0,
0,0,0,0,k_3_0,0,0,b1_1_4,0,0,
0,0,0,0,0,k_3_1,a1_0_4*A,0,0,0,
...
py::array_t<double> interfacerhos(py::array_t<double> parsar, py::array_t<double> varvals ) {
    ...
    py::array_t<double> resultpy = py::array_t<double>(10);
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    std::vector<int> indicesC={8,9};
    std::vector<int> coeffsC={11,23};
    ...
    PYBIND11_MODULE(bPcycle_1bs_5states_rev1u2_TFA_prec100,m){
