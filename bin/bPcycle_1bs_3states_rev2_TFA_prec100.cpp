...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double b1_1_2=pars[9];
    long double k_2_1=pars[10];
    long double kr_2_1=pars[11];
    ...
    L<<0,b1_1_1,0,0,k_3_0,0,
a1_0_1*A,0,0,0,0,k_3_1,
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_3states_rev2_TFA_prec100,m){
