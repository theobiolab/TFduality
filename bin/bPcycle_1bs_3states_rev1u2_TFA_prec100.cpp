...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double b1_1_1=pars[8];
    long double k_1_1=pars[9];
    long double kr_1_1=pars[10];
    long double b1_1_2=pars[11];
    long double k_2_1=pars[12];
    long double kr_2_1=pars[13];
    long double b1_1_3=pars[14];
    long double k_3_1=pars[15];
    Matrix<InternalType, Dynamic, Dynamic> L = Matrix<InternalType, Dynamic, Dynamic>::Zero(6, 6);
    L<<0,b1_1_1,kr_1_0,0,k_3_0,0,
a1_0_1*A,0,0,kr_1_1,0,k_3_1,
k_1_0,0,0,b1_1_2,kr_2_0,0,
0,k_1_1,a1_0_2*A,0,0,kr_2_1,
0,0,k_2_0,0,0,b1_1_3,
0,0,0,k_2_1,a1_0_3*A,0;
...
py::array_t<double> interfacerhos(py::array_t<double> parsar, py::array_t<double> varvals ) {
    ...
    py::array_t<double> resultpy = py::array_t<double>(6);
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    std::vector<int> indicesC={4,5};
    std::vector<int> coeffsC={7,15};
    ...
    PYBIND11_MODULE(bPcycle_1bs_3states_rev1u2_TFA_prec100,m){
