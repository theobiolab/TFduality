...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double a1_0_3=pars[4];
    long double k_3_0=pars[5];
    long double kr_3_0=pars[6];
    ...
    long double b1_1_3=pars[13];
    long double k_3_1=pars[14];
    long double kr_3_1=pars[15];
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_4states_rev3_TFA_prec100,m){
