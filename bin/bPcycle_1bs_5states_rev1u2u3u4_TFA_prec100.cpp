...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double kr_3_0=pars[8];
    long double a1_0_4=pars[9];
    long double k_4_0=pars[10];
    long double kr_4_0=pars[11];
    long double a1_0_5=pars[12];
    long double k_5_0=pars[13];
    long double b1_1_1=pars[14];
    long double k_1_1=pars[15];
    long double kr_1_1=pars[16];
    long double b1_1_2=pars[17];
    long double k_2_1=pars[18];
    long double kr_2_1=pars[19];
    long double b1_1_3=pars[20];
    long double k_3_1=pars[21];
    long double kr_3_1=pars[22];
    long double b1_1_4=pars[23];
    long double k_4_1=pars[24];
    long double kr_4_1=pars[25];
    long double b1_1_5=pars[26];
    long double k_5_1=pars[27];
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_5states_rev1u2u3u4_TFA_prec100,m){
