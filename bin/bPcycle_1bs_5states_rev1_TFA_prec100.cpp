...
Matrix<InternalType, Dynamic, 1> getrhos(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    long double a1_0_5=pars[9];
    long double k_5_0=pars[10];
    long double b1_1_1=pars[11];
    long double k_1_1=pars[12];
    long double kr_1_1=pars[13];
    long double b1_1_2=pars[14];
    long double k_2_1=pars[15];
    long double b1_1_3=pars[16];
    long double k_3_1=pars[17];
    long double b1_1_4=pars[18];
    long double k_4_1=pars[19];
    long double b1_1_5=pars[20];
    long double k_5_1=pars[21];
...
k_1_0,0,0,b1_1_2,0,0,0,0,0,0,
0,k_1_1,a1_0_2*A,0,0,0,0,0,0,0,
...
double interfacess(py::array_t<double> parsar, py::array_t<double> varvals){
    ...
    PYBIND11_MODULE(bPcycle_1bs_5states_rev1_TFA_prec100,m){
