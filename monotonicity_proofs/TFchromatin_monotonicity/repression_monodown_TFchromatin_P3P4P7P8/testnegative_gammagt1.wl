...
Print[final];
timec = 600;
outfname = StringJoin["./resultsgammagt1/", "checked_", ToString[init], "_", ToString[final], ".out"];
(*tempdir1="//"
...
While[Not[SameQ[line, EndOfFile]] && i <= final,
 If[i >= init && i <= final,
  ...
  out1 = With[{assum = 0 <alpha < 1 && 0 < beta < 1 && omega > 1 && gamma > 1}, 
